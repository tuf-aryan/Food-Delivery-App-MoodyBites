...
const RestaurantCard = (props) => {
  ...
  return (
    <div className=" w-72 h-86 sm:w-56 sm:h-72 m-4 border border-gray-200 shadow-lg">
    <div>
      <img
        className="w-72 h-56 sm:w-56 sm:h-44 p-4"
        src={CDN_URL+resData?.info?.cloudinaryImageId}>
      </img>
      <h3 className="font-bold py-2 text-s mx-3 truncate">{name}</h3>
